...
email.sendEmail = async (req, callback) => {
  ...
  let mailOptions = {
    ...
    text:
      "Has recibido un mensaje desde el Web Site, Asunto: " +
      req.body.asunto +
      " E-mail: " +
      req.body.email +
      " Nombre: " +
      ...
      req.body.content,
    html:
      "<p>Has recibido un mensaje desde Web Site</p><ul><li>Asunto: " +
      req.body.asunto +
      "</li><li>E-mail: " +
      req.body.email +
      "</li><li>Nombre: " +
...
email.validateEmail = email => {
  ...
  if (regular_expression.test(email)) {
    ...
    return (list_white_server_email.indexOf(servidor_email[0])) > -1
      ? true
      : false;
  } else {
    return false;
